...
public final class MyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest,
      com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest.class,
      responseType = com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest,
      com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest, com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest, com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest,
                com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply sayHello(com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply> sayHello(
        com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.stub.stub_Rest_gRPC.serviceGRPC.serviceHello.HelloWorldProto.getDescriptor();
    }
